...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { album: @music.album, artist: @music.artist, musician_id: @music.musician_id, time: @music.time, track: @music.track }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { album: @music.album, artist: @music.artist, musician_id: @music.musician_id, time: @music.time, track: @music.track }
    assert_redirected_to music_path(assigns(:music))
  end
